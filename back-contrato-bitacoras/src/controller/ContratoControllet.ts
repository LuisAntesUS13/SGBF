...
import { ConsultaContratosRequest, ConsultaPerfilesContratosRequest, RegistraActualizaContratoRequest, RegistraActualizaPerfilContratoRequest } from "../model/request/request";
