...
export const Requerimientos = () => {
    ...
    // Estado para manejar la selección, definiendo explícitamente el tipo como un arreglo de números
    ...
    const data = [
        {
          perfil: 'CT-0015-24',
          consultor: 'Joel Cuevas Carbajal',
          smax: 'SMAX-2024 / 1001',
          descripcionCorta: 'Incidente en servidor principal',
          liderProyecto: 'Ana Morales',
          responsable: 'Carlos Díaz',
          tipo: 'Incidente',
          aplicativoModulo: 'ERP Finanzas',
          areaAtencion: 'Tecnología'
        },
        {
          perfil: 'CT-0016-24',
          consultor: 'María López Pérez',
          smax: 'SMAX-2024 / 1002',
          descripcionCorta: 'Error en base de datos',
          liderProyecto: 'Luis González',
          responsable: 'Raúl Castillo',
          tipo: 'Solicitud',
          aplicativoModulo: 'CRM Ventas',
          areaAtencion: 'Operaciones'
        },
        {
          perfil: 'CT-0017-24',
          consultor: 'Pedro Sánchez Torres',
          smax: 'SMAX-2024 / 1003',
          descripcionCorta: 'Problema de acceso a aplicación',
          liderProyecto: 'Laura García',
          responsable: 'Marta Ramos',
          tipo: 'Incidente',
          aplicativoModulo: 'Portal Web',
          areaAtencion: 'Soporte'
        },
        {
          perfil: 'CT-0018-24',
          consultor: 'Ana Fernández García',
          smax: 'SMAX-2024 / 1004',
          descripcionCorta: 'Falla en reporte de ventas',
          liderProyecto: 'Gabriel Rojas',
          responsable: 'Sofía Martínez',
          tipo: 'Incidente',
          aplicativoModulo: 'BI Reporting',
          areaAtencion: 'Finanzas'
        },
        {
          perfil: 'CT-0019-24',
          consultor: 'Juan Carlos Domínguez',
          smax: 'SMAX-2024 / 1005',
          descripcionCorta: 'Solicitud de mejora en interfaz',
          liderProyecto: 'Victoria Ruiz',
          responsable: 'Andrés Mejía',
          tipo: 'Solicitud',
          aplicativoModulo: 'Aplicación Móvil',
          areaAtencion: 'Desarrollo'
        }
      ];
    ...
    const handleSelectAll = (event) => {
        if (event.target.checked) {
            setSelectedRows(data.map((_, index) => index)); // Seleccionar todos los índices
        } else {
            setSelectedRows([]); // Deseleccionar todos
        }
    };

    // Manejar selección de una fila específica
                                ...
                                <tbody>
                                    {data.map((row, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className="valoresCentrados">{row.perfil}</td>
                                            <td className="valoresCentrados">{row.consultor}</td>
                                            <td className="valoresCentrados">{row.smax}</td>
                                            <td className="valoresCentrados">{row.descripcionCorta}</td>
                                            <td className="valoresCentrados">{row.liderProyecto}</td>
                                            <td className="valoresCentrados">{row.responsable}</td>
                                            <td className="valoresCentrados">{row.tipo}</td>
                                            <td className="valoresCentrados">{row.aplicativoModulo}</td>
                                            <td className="valoresCentrados">{row.areaAtencion}</td>
