...
export const InputCalendario: React.FC<CalendarioProps> = ({
  ...
  const generaSemana = () => {
    const semana: string[] = ["Lun", "Mar", "Mie", "Jue", "Vie", "Sab", "Dom"];
      ...
      {showCalendario && (
        <div className="border" onBlur={handleBlur} tabIndex={0}>
          <div className="contenido-botones">
            <div
              className="col-sm-1 izquierda-cal"
              onClick={() => {
                cambioMesFlechas(false);
              }}
            >
            ...
            <div
              className="col-sm-1 derecha-cal"
              onClick={() => {
                cambioMesFlechas(true);
              }}
            >
          ...
          <ol className="class-ol">
            {semanas.map((option) => (
              <li className="class-li day-name" key={option}>
                {option}
              </li>
            ))}
