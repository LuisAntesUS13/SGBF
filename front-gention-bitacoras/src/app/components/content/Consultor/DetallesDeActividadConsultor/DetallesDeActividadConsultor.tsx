                ...
                <div>
                  ...
                  <div className="contenedor-observaciones-realizadas">
                    <ul className="contenedor-observaciones">
                      ...
                      <li>
                        Azir Aguilar(12/01/2024): Quiero destacar tu dedicación
                        al completar el análisis del informe técnico. Has
                        demostrado una buena comprensión del material al
                        resaltar los aspectos clave. Sin embargo, considero que
                        podrías profundizar más en ciertos detalles y ofrecer
                        sugerencias adicionales para enriquecer aún más el
                        análisis en futuras revisiones.
                      </li>
                    </ul>
                  </div>
                </div>
